...
namespace BLLayer
{
   public class VendorGroupManager:Repository<VendorGroup>
    {
        ...
        protected sealed override void CreateRows(ref DataTable dt, IQueryable<VendorGroup> SourceData)
        {
            dt.Rows.Clear();
            foreach (VendorGroup gr in SourceData)
            {
